...
const CreateContainer = () => {
  ...
  const [alerteStatus, setAlerteStatus] = useState("danger");
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center  ">
      <div
        className="w-[90%] md:w-[75%] border border-gray-300 rounded-lg p-4 flex flex-col items-center
            ...
            <>
              {!imageAsset ? (
                ...
                <>
                  ...
                  text-xl cursor-pointer outline-none hover:shadow-lg duration-500 transition-all ease-in-out"
                      onClick={deleteImage}
                    >
                      {" "}
