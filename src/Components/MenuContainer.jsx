...
const MenuContainer = () => {
  const [filter, setFilter] = useState("poulets"); 
          ...
          {categories &&
            categories.map((category) => (
              ...
              whileTap={{scale:0.75}}
                ...
                } w-24 min-w[94] h-28 cursor-pointer rounded-lg
             drop-shadow-xl flex flex-col gap-3 items-center justify-center hover:bg-cartNumBg
            `}
